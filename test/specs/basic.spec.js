...
describe('main page testing',() => {
    ...
    xit('log in with wrong credentials', async () => {
    ...
    xit('log in with empty values', async() => {
        await main.clickLoginButton();
        await loginPage.clickLoginButton();
        await loginPage.currentPageUrl()
    })

    it('log in with google', async() => {
        await main.clickLoginButton();
        await loginPage.clickloginWithGoogle();
        await browser.switchWindow('https://accounts.google.com/o/oauth2/auth/identifier')
        await redirectingPage.googleHeaderIsVisible()
    })

    xit('full log in with github', async() => {
        await main.clickLoginButton();
        await loginPage.clickLoginWithAnotherProvider();
        await loginPage.clickLoginWithGithub();
        await redirectingPage.setGitEmail();
        await redirectingPage.setGitPassword();
        await redirectingPage.clickGitSignInButton();
        await loginPage.homeHeaderIsVisible();
        await homePage.accountDropdownFocus();
        await homePage.clickLOgOutButton()
    })

    xit('full log in with linkedIn', async() => {
        await main.clickLoginButton();
        await loginPage.clickLoginWithAnotherProvider();
    ...
    xit('log in with linkedin', async() => {
        await main.clickLoginButton();
        await loginPage.clickLoginWithAnotherProvider()
        await loginPage.clickLoginWithLinkedin();
        await redirectingPage.linkedinHeaderIsVisible()
    })

    xit('log in with github', async() => {
        await main.clickLoginButton();
        await loginPage.clickLoginWithAnotherProvider()
        await loginPage.clickLoginWithGithub();
    ...
    xit('sign up with valid values', async() => {
    ...
    xit('sign up with empty values', async() => {
        await main.clickSignUpButton();
        await signUpPage.clickCreateAccountButton();
    ...
    xit('get all feft sidebar menu list texts', async() => {
        await main.clickLoginButton();
        await loginPage.setEmailValue('phenom2405@gmail.com');
        await loginPage.setPasswordValue('Noone123456.');
        await loginPage.clickLoginButton();
